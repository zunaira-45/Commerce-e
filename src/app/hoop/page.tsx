  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-2'>
        <div>
            <img src="images/sofa.png" alt="image"></img>
        </div>
        <div>
         ...
         Excitation venial consequent sent nostrum met.
               ...
               <div className='flex items-center justify-center gap-5'>
                <button className='bg-blue-500 text-white m-4 p-4'>
                    Select Option
                </button>
               <p> <IoMdHeartEmpty/> </p>
                <p><IoCartOutline/></p>
               ...
               <div className='grid grid-cols-3'>
                <div>
                    <img src="images/room.png"></img>
                </div>

                <div className='md:flex space-x-5'>
                    2
                    <h1 className='font-bold text-2xl'>the quick fox jumps over </h1>
                    <p>
...
<div className='grid grid-cols-4'>
    <div>
        <img src="images/folk.png" alt="image"></img>
    ...
    <div>
        <img src="images/glass.png" alt="image"></img>
        <h1>Graphic Design</h1>
        <p className='text-gray-400'>English Department</p>
        <p>$16.48 $6.48</p>
        <img src="images/light.png" alt="image"></img>
    ...
    <div>
    <img src="images/spoon.png" alt="image"></img>
        <h1>Graphic Design</h1>
        <p className='text-gray-400'>English Department</p>
        <p>$16.48 $6.48</p>
        ...
        <div>
        <img src="images/cafe.png" alt="image"></img>
        <h1>Graphic Design</h1>
        <p className='text-gray-400'>English Department</p>
        <p>$16.48 $6.48</p>
        <img src="images/light.png" alt="image"></img>
...
<div className='grid grid-cols-4'>
    <div>
        <img src="images/graphic.png" alt='image'></img>
        <h1>Graphic Design</h1>
        <p className='text-gray-400'>English Department</p>
        <p>$16.48 $6.48</p>
        <img src="images/light.png" alt='image'></img>
    ...
    <div>
    <img src="images/chair.png" alt='image'></img>
        <h1>Graphic Design</h1>
        <p className='text-gray-400'>English Department</p>
        <p>$16.48 $6.48</p>
        <img src="images/light.png" alt='image'></img>
